    ...
    <div class="flex-wrap items-center justify-center gap-8 text-center sm:flex">
        <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
            <div class="flex-shrink-0">
                <div class="flex items-center justify-center w-12 h-12 mx-auto text-white bg-custom rounded-md">
            ...
            <h3 class="py-4 text-2xl font-semibold text-gray-700 whitespace-normal">
                {{ $t("message.Step1Sub1")}}
            </h3>
