...
const messages = {
    ...
    fr: {
      message: {
        ...
        Step1Title1: 'Vos bacs ne sont pas propre ? Nous sommes la !',
        Step1Sub1: 'Recyclage, poubelle ou composte',
        Step1Sub2: ' Des bacs ça se sali. Apres seulement quelques jours, vos bacs peuvent acquérir de la saleté, des odeurs désagréables et une panoplie de bactéries.',
        Step1Sub3: 'C\'est pourquoi nous somme la !',
        Step2Title1: 'Laissez les dans vos entrées, et nous nous occupons du reste !',
        Step2Sub1: 'Une fois votre demande confirmée, nous vous enverons un couriel pour vous informez de votre premier lavage. Dépendemment de la fréquence de nos visites, vous recevrez une notification pour vous informez de notre passage. Une fois lavés, nous ramenerons vos bacs sur le bord de la maison',
        Step3Title1: 'Désinfecte, nettoie et désodorise',
        Step3Sub1: 'Une fois lavés, vos bacs seront',
        Step3Sub2: 'propres, désinfectés et sans odeurs !',
        Step3Sub3: 'En effet, nos produits élimine les',
        Step3Sub4: 'bactéries, les odeurs et les tache tenaces',
        Step3Sub5: 'qui se retrouvent sur la surface de votre bac',
        Step4Title1: 'Inscrivez vous pour la saison 2022 !',
        Step4Sub1: 'inscrivez vous, sans obligations, pour la',
        Step4Sub2: 'saison 2022',
        Step4Sub3: 'et nous vous contacterons en Mars pour confirmer votre demande',
        FormTitle: 'Inscription',
        FormTitle2: 'Informez nous du forfait qui vous interesse et inscrivez vous sans obligations, pour la saison 2022. Nous vous enverons une confirmation par couriel en Mars',
        FormSub1: 'courriel',
        FormSub2: 'Téléphone',
        FormSub3: 'Forfait et Adresse',
        FormSub4: 'Ces offres ne sont disponible que pour les résidents de les villes de',
        FormSub5: 'Saint-Jean-Sur-Richelieu, Iberville et L\'acadie.',
        Header1: 'Forfaits',
